jQuery("#simulation")
  .on("click", ".s-4c7b41a0-6f3f-4197-989c-20b38bf110a2 .click", function(event, data) {
  ...
  .on("pageload", ".s-4c7b41a0-6f3f-4197-989c-20b38bf110a2 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("windowscroll", ".s-4c7b41a0-6f3f-4197-989c-20b38bf110a2 .windowscroll", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
